...
def createScene(rootNode):
    ...
    for i in range(nr_vertebrae):
        ...
        curr_vert_id = str(i + 1)
        curr_vert = together.addChild('vert' + curr_vert_id)
    ...
    for i in range(1, nr_vertebrae):
        idx_first_vertebra = str(i)
        idx_second_vertebra = str(i + 1)
        ...
        together.addObject('StiffSpringForceField',
                           ...
                           object1=object1,
                           object2=object2,
                           spring=json_data['springs'][curr_vertebrae_pair]['body'])
        ...
        together.addObject('StiffSpringForceField',
                           ...
                           object1=object1,
                           object2=object2,
                           spring=json_data['springs'][curr_vertebrae_pair]['facet_left'])
        ...
        together.addObject('StiffSpringForceField',
                           ...
                           object1=object1,
                           object2=object2,
                           spring=json_data['springs'][curr_vertebrae_pair]['facet_right'])

    # add positions of fixed points for v1
    fixed_points_L1 = together.addChild('fixed_points1')
    fixed_points_L1.addObject('MechanicalObject',
                              name='Particles1',
                              template='Vec3d',
                              position=json_data['fixed_points_positions']['v1'])
    fixed_points_L1.addObject('MeshTopology',
                              name='Topology',
                              hexas=json_data['fixed_points_indices']['v1'])
    fixed_points_L1.addObject('UniformMass', name='Mass', vertexMass='1')
    fixed_points_L1.addObject('FixedConstraint',
                              template='Vec3d',
                              name='fixedConstraint1',
                              indices=json_data['fixed_points_indices']['v1'])

    # add positions of fixed points for v5
    fixed_points_L5 = together.addChild('fixed_points5')
    fixed_points_L5.addObject('MechanicalObject',
                              name='Particles5',
                              template='Vec3d',
                              position=json_data['fixed_points_positions']['v5'])
    fixed_points_L5.addObject('MeshTopology',
                              name='Topology',
                              hexas=json_data['fixed_points_indices']['v5'])
    fixed_points_L5.addObject('UniformMass', name='Mass', vertexMass='1')
    fixed_points_L5.addObject('FixedConstraint',
                              template='Vec3d',
                              name='fixedConstraint5',
                              indices=json_data['fixed_points_indices']['v5'])
